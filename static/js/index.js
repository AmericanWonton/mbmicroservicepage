...
function initializeWhatPage(thePage){
    //console.log("The page num for messages is currently: " + thePage);
    whatPage = thePage;
}
...
function messageDataInitialize(theData){
    ...
    */
   //console.log("Beginning to make the message array...");
    var j = 0;
    for (j = 0; j < originalMessageArray.length; j++){
        //console.log("DEBUG: Here is our message arrary at spot " + j + ": " + originalMessageArray[j].TheMessage);
    }
